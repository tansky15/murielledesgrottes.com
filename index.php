              ...
              <div class="chapter__preview2-container">
                ...
                >
                  <a
                    ...
                    class="glightbox2"
                    href="assets/images/chapter-preview/cover-1.jpg"
                  >
                  </a>
                  <h3>The King</h3>
                </div>
                <div class="chapters__content glightbox-desc custom-desc1">
                  <div class="content__body">
                    <h3 class="mb-4 text-center">The King</h3>
                ...
                >
                  <a
                    ...
                    class="glightbox2"
                    href="assets/images/chapter-preview/cover-2.jpg"
                  >
                  </a>
                  <h3>Death & Dark</h3>
                </div>
                <div class="chapters__content glightbox-desc custom-desc2">
                  <div class="content__body">
                    <h3 class="mb-4 text-center">Death & Dark</h3>
                    <p class="first-letter">
                      Dpsum vehicula eros ultrices lacinia Vestibulum ante ipsum
                      primis in faucibus orci luctus et ultrices posuere cubilia
                      Curae Duis quis ipsum vehicula eros ultrices lacinia.
                ...
                >
                  <a
                    ...
                    class="glightbox2"
                    href="assets/images/chapter-preview/cover-3.jpg"
                  >
                  </a>
                  <h3>Chapter 03</h3>
                </div>
                <div class="chapters__content glightbox-desc custom-desc3">
                  <div class="content__body">
                    <h3 class="mb-4 text-center">Chapter 03</h3>
                    <p class="first-letter">
                      Dpsum vehicula eros ultrices lacinia Vestibulum ante ipsum
                      primis in faucibus orci luctus et ultrices posuere cubilia
                      Curae Duis quis ipsum vehicula eros ultrices lacinia.
                ...
                >
                  <a
                    ...
                    class="glightbox2"
                    href="assets/images/chapter-preview/cover-4.jpg"
                  >
                  </a>
                  <h3>Sing Souls</h3>
                </div>
                <div class="chapters__content glightbox-desc custom-desc4">
                  <div class="content__body">
                    <h3 class="mb-4 text-center">Sing Souls</h3>
                    <p class="first-letter">
                      Dpsum vehicula eros ultrices lacinia Vestibulum ante ipsum
                      primis in faucibus orci luctus et ultrices posuere cubilia
                      Curae Duis quis ipsum vehicula eros ultrices lacinia.
                ...
                >
                  <a
                    ...
                    class="glightbox2"
                    href="assets/images/chapter-preview/cover-5.jpg"
                  >
                  </a>
                  <h3>The Mermaid</h3>
                </div>
                <div class="chapters__content glightbox-desc custom-desc5">
                  <div class="content__body">
                    <h3 class="mb-4 text-center">The Mermaid</h3>
                    <p class="first-letter">
                      Dpsum vehicula eros ultrices lacinia Vestibulum ante ipsum
                      primis in faucibus orci luctus et ultrices posuere cubilia
                      Curae Duis quis ipsum vehicula eros ultrices lacinia.
                ...
                >
                  <a
                    ...
                    class="glightbox2"
                    href="assets/images/chapter-preview/cover-6.jpg"
                  >
                  </a>
                  <h3>The Worst</h3>
                </div>
                <div class="chapters__content glightbox-desc custom-desc6">
                  <div class="content__body">
                ...
                <div class="chapters__content glightbox-desc custom-desc7">
                  <div class="content__body">
                    <h3 class="mb-4 text-center">History & Prid</h3>
                    <p class="first-letter">
                      Dpsum vehicula eros ultrices lacinia Vestibulum ante ipsum
                ...
                <div class="chapters__content glightbox-desc custom-desc8">
                  <div class="content__body">
                    <h3 class="mb-4 text-center">History & Prid</h3>
                    <p class="first-letter">
                      Dpsum vehicula eros ultrices lacinia Vestibulum ante ipsum
        ...
        <div class="container">
          ...
          <div class="gallery__menu">
            <ul>
              ...
              <li data-filter=".comics">Comics</li>
              <li data-filter=".history">History</li>
            </ul>
          </div>
          <div class="gallery__area row gallery-active">
            <div class="grid-item col-xl-4 col-lg-4 col-md-6 fiction">
              <div class="gallery__item m-15px-b m-15px-t">
                <img
                ...
                <div class="gallery-title-wrapper">
                  <div class="gallery-title-wrapper--content">
                    <h2
                      class="fs-4"
                      data-bs-toggle="modal"
                      data-bs-target="#galleryModal"
                    >
                      <a href="#">Things I Never Said</a>
                    </h2>
                    <p>Fiction</p>
                  </div>
                  <button
            ...
            <div class="grid-item col-xl-4 col-lg-4 col-md-6 fantasy">
              <div class="gallery__item m-15px-b m-15px-t">
                <img
            ...
            <div class="grid-item col-xl-4 col-lg-4 col-md-6 comics">
              <div class="gallery__item m-15px-b m-15px-t">
                <img
                ...
                <div class="gallery-title-wrapper">
                  <div class="gallery-title-wrapper--content">
                    <h2
                      ...
                      data-bs-target="#galleryModal"
                    >
                      <a href="#">Leave The World Behind</a>
                    </h2>
                    <p>Comics</p>
                  </div>
                  <button
            ...
            <div class="grid-item col-xl-4 col-lg-4 col-md-6 history">
              <div class="gallery__item m-15px-b m-15px-t">
                <img
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-main">
                  ...
                  <div class="gallery__inpormation__wrapper">
                    <div class="gallery__thumb">
                      <img
                        src="assets/images/chapter-preview/6.png"
                        alt="thumbnail"
                      />
                    </div>
                    <div class="gallery__client__meta row">
                      <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                        <div class="client__meta">
                          <p>Published On:</p>
                          <h5>August 05, 2023</h5>
                        </div>
                      </div>
                      <hr class="hr" />
                    </div>
                    <div class="gallery__details">
                      <h3>Things I Never Said</h3>
                      <p>
                        Maecenas sed tortor molestie, sagittis nibh sit amet,
                        dapibus felis. Vivamus sed neque iaculis, ultrices nulla
                        eu, venenatis dui. Praesent luctus urna eu dapibus
                        pulvinar. Curabitur sed magna accumsan neque fermentum
                        laoreet. Ut nunc.
                      </p>
                      <ul>
                        <li>
                          <i class="icofont-check"></i>
                          <p>Will you provide website layout about design</p>
                        </li>
                        <li>
                          <i class="icofont-check"></i>
                          <p>Branding With Business Agency</p>
                        </li>
                        <li>
                          <i class="icofont-check"></i>
                          <p>
                        ...
                        <li>
                          <i class="icofont-check"></i>
                          <p>How much do you charge for branding</p>
                        </li>
                      </ul>
                    </div>
                  </div>
          ...
          <div class="row">
            ...
            >
              <div class="books__book h-100 translateEffect1">
                ...
                <div class="chapters__content glightbox-desc custom-desc1">
                  <div class="content__body">
                    <h3 class="mb-4 text-center">Think & grow rich</h3>
                    <p class="first-letter">
                      Dpsum vehicula eros ultrices lacinia Vestibulum ante ipsum
                      primis in faucibus orci luctus et ultrices posuere cubilia
                      Curae Duis quis ipsum vehicula eros ultrices lacinia.
            ...
            >
              <div class="books__book h-100 translateEffect1">
                ...
                <div class="chapters__content glightbox-desc custom-desc2">
                  <div class="content__body">
                    <h3 class="mb-4 text-center">Rich dad, poor dad</h3>
                    <p class="first-letter">
                      Dpsum vehicula eros ultrices lacinia Vestibulum ante ipsum
                      primis in faucibus orci luctus et ultrices posuere cubilia
                      Curae Duis quis ipsum vehicula eros ultrices lacinia.
            ...
            >
              <div class="books__book h-100 translateEffect1">
                ...
                <div class="chapters__content glightbox-desc custom-desc3">
                  <div class="content__body">
                    <h3 class="mb-4 text-center">Eat that frog</h3>
                    <p class="first-letter">
                      Dpsum vehicula eros ultrices lacinia Vestibulum ante ipsum
                      primis in faucibus orci luctus et ultrices posuere cubilia
                      Curae Duis quis ipsum vehicula eros ultrices lacinia.
            ...
            >
              <div class="books__book h-100 translateEffect1">
                ...
                <div class="chapters__content glightbox-desc custom-desc4">
                  <div class="content__body">
                    <h3 class="mb-4 text-center">Design Patterns</h3>
                    <p class="first-letter">
                      Dpsum vehicula eros ultrices lacinia Vestibulum ante ipsum
                      primis in faucibus orci luctus et ultrices posuere cubilia
                      Curae Duis quis ipsum vehicula eros ultrices lacinia.
          ...
          <div class="row">
            ...
            >
              <div class="contact-form-box">
                <form id="contact-form" method="post" action="https://themeatelier.net/site-templates/wonted/one-page-version/php/sendmail.php">
          ...
          <div class="row justify-content-center cta__inner bg-one">
            <div class="col-lg-8">
              ...
              <div class="cta-form-box">
                ...
                <form action="https://themeatelier.net/site-templates/wonted/one-page-version/assets/subscribe/subscribe.php" id="subscribe2">
                  <div
                    class="mb13"
                    data-aos="fade-up"
                    data-aos-duration="1000"
